    ...
    <form action="" method="post">
        <ul>
            <li>
                ...
                <input type="text" name="kode_pakaian" id="kode_pakaian" require>
            </li>
            <li>
                <label for="jenis">Jenis Pakaian : </label>
                <input type="text" name="jenis" id="jenis" require>
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="ukuran" id="ukuran"require>
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="stok" id="stok"require>
            </li>
            <li>
